...
public class RandomSequenceGeneratorImplTest {
    ...
    public void shouldCreateSequenceOfGivenSizeWithinGivenArea() {
        ...
        var objectUnderTest = new RandomSequenceGeneratorImpl();
    ...
    public void shouldCreateSameSequenceInTwoGeneratorsWithSameSeed() {
        ...
        var count = 10000;
        var sideLength = 10000;
        var objectUnderTest1 = new RandomSequenceGeneratorImpl(6871162586L);
        var objectUnderTest2 = new RandomSequenceGeneratorImpl(6871162586L);
    ...
    public void shouldCreateDifferentSequencesInTwoGeneratorsWithDifferentSeed() {
        ...
        var count = 10000;
        var sideLength = 10000;
        var objectUnderTest1 = new RandomSequenceGeneratorImpl(9156871100L);
        var objectUnderTest2 = new RandomSequenceGeneratorImpl(2002262586L);
